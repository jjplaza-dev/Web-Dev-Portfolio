  ...
  return <>
    <section className='w-screen h-screen relative '>
      <div className='w-full h-[100vh] bg-[#1b1b1b] absolute ' id='frontBox'>
        <div className='w-[60vw] sm:w-[40vw] md:w-[30vw] lg:w-[20vw] absolute bottom-[10%] right-[10%] aspect-[1/1.4] bg-amber-50 m-auto ' style={{boxShadow: `${curPos.x/10}px ${curPos.y/10}px gray`}} id='profileBox'>
