...
function Navigation() {
  return <>
    <section className="fixed w-full md:w-[5vw] h-full top-0 md:left-0 z-2">
      <div className="w-full md:w-fit h-15 md:h-full border-sticky top-0 flex justify-center border-r-1 border-black items-center backdrop-blur-md bg-white/80">
